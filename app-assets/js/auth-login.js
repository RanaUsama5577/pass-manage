...
$(async function () {
    ...
    loginForm.addEventListener('submit', (e) => {
        ...
        //if else statment for log in form

        if (email == "" && password == ""){
            sweetMessage("Error", "Enter email and password", "warning");
            return false;
        }
            ...
            $('#login-email').addClass('is-invalid');
            sweetMessage("Error", "Email/Password not recognized", "warning");
            return false;
        }

        $('#login-button').addClass("btn-progress");

        //end of if else for log in 
        ...
        if (email == "") {
            $('#login-email').addClass('is-invalid');
            sweetMessage("Sign-In Failed!", "Please Enter Email/Password", "warning");
            return false;
        }
        else if (!validateEmail(email)) {
            $('#login-email').addClass('is-invalid');
            sweetMessage("Sign-In Failed!", "Email/Password Not Recognized", "warning");
            return false;
        }
        else if (password == "") {
            $('#login-email').removeClass('is-invalid');
            $('#login-password').addClass('is-invalid');
            sweetMessage("Sign-In Failed!", "Please Enter Password", "warning");
            return false;
        }
        $('#login-button').addClass("btn-progress");*/
        ...
        //        console.log(ref);
                ...
                auth.signInWithEmailAndPassword(getauth, email, password).then((cred) => {
                    ...
                    .catch(function (error) {
                        ...
                        sweetMessage("Sign-In Failed!", "Unknown Email/Password combination", "warning");
                    });
            //})
            //.catch((error) => {
            //    console.log(error);
